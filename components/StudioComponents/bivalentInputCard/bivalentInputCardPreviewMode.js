...
function BivalentInputCardPreviewMode(props) {
    ...
    return (
        <>
            <div className="transition ease-in-out duration-500 w-full none:shadow hover:shadow-md border	rounded-sm text-blue-900 text-lg p-5 mb-2 select-none bg-gray-50">
                {/* question row */}
