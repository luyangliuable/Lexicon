        ...
        <div className="w-full h-10 mb-1 bg-blue-100 border-1 rounded flex justify-around border-blue-900">
            {props.editModeVal ?
                (<><div className="py-0.5 w-1/12">
                    ...
                    <div className="py-0.5 w-1/12">
                        <div className="h-full text-center pt-1 border rounded bg-red-600 text-white hover:bg-red-500 cursor-pointer" onClick={() => props.deleteFunction({ type: "DELETE_UNIT", value: uuid })}>
